#!/usr/bin/env python3
"""GPU dependency installer for lpf.

Usage:
    python -m lpf.install            # auto-detect CUDA, install CuPy + PyTorch
    python -m lpf.install --cuda 130 # force CUDA 13.0
    python -m lpf.install --cpu      # skip GPU packages
"""
